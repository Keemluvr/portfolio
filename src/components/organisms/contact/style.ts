export const classNameContact = {
  ...
  contactLink: "text-secondary hover:underline",
  contactEmail: "flex justify-center gap-2 text-lg lg:text-2xl hover:text-secondary transition-all text-wrap break-all",
  contactIcon: "self-start mt-1"
};
